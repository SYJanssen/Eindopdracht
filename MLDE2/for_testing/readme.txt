MLDE2 MATLAB .NET Assembly (.NET Component)
...
MLDE2_overview.html - HTML overview documentation file for the generated component. It 
                      contains the requirements for accessing the component and for 
                      generating arguments using the MWArray class hierarchy.

MLDE2.xml - This file contains the code comments for the MLDE2 component classes and 
                      ...
                      online documentation for the MLDE2 component.
